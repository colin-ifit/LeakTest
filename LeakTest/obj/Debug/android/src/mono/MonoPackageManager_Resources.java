...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "LeakTest.dll" comes first in this list. */
		"LeakTest.dll",
		"LeakCanary.Android.Core.dll",
		"LeakCanary.Android.dll",
		"LeakCanary.ObjectWatcher.Android.dll",
		"LeakCanary.ObjectWatcher.AndroidSupportFragments.dll",
		"LeakCanary.ObjectWatcher.AndroidX.dll",
		"LeakCanary.ObjectWatcher.dll",
		"Shark.dll",
		"SharkAndroid.dll",
		"SharkGraph.dll",
		"SharkHprof.dll",
